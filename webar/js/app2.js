!function(e, t) {
    ...
    class t {
        static request(e, t, i=null) {
            return new Promise((s,n)=>{
                ...
                o.open(e, t),
                i ? (o.setRequestHeader("Content-Type", "application/json;Charset=UTF-8"),
                o.send("string" == typeof i ? i : JSON.stringify(i))) : o.send()
            }
            )
        }
        static post(e, i) {
    ...
    class i {
        ...
        listCamera(e) {
            return this.videoDeviceElement = e,
            new Promise((e,t)=>{
                navigator.mediaDevices.enumerateDevices().then(i=>{
                    ...
                    0 === this.videoDeviceElement.length ? t("没有摄像头") : (this.videoDeviceElement.style.display = "inline-block",
            ...
            new Promise((e,t)=>{
                navigator.mediaDevices.getUserMedia(i).then(i=>{
                    ...
                    this.videoElement.onloadedmetadata = (()=>{
                        ...
                        window.innerWidth < window.innerHeight ? this.videoElement.offsetHeight < window.innerHeight && this.videoElement.setAttribute("height", window.innerHeight.toString() + "px") : this.videoElement.offsetWidth < window.innerWidth && this.videoElement.setAttribute("width", window.innerWidth.toString() + "px"),
                        e(!0)
                    }
                    );
        ...
        captureVideo() {
            return this.canvasContext.drawImage(this.videoElement, 0, 0, this.videoSetting.width, this.videoSetting.height),
            this.canvasElement.toDataURL("image/jpeg", .5).split("base64,")[1]
        }
        startRecognize(e) {
    ...
    class o {
        ...
        resetModel() {
            this.camera.position.set(this.setting.cameraPosition[0], this.setting.cameraPosition[1], this.setting.cameraPosition[2]),
            this.camera.lookAt(new e.Vector3(this.setting.position[0],this.setting.position[1],this.setting.position[2])),
            this.model.position.set(this.setting.position[0], this.setting.position[1], this.setting.position[2]),
            this.model.scale.setScalar(this.setting.scale)
        }
        loadModel(t, i, s, n) {
            this.setting = i;
            const o = new e.SpotLight(16777215,.2);
            o.position.set(i.lightPosition[0], i.lightPosition[1], i.lightPosition[2]),
            o.castShadow = !0,
            this.scene.add(o),
            this.camera.position.set(i.cameraPosition[0], i.cameraPosition[1], i.cameraPosition[2]),
            this.camera.lookAt(new e.Vector3(i.position[0],i.position[1],i.position[2])),
                ...
                t.animations.length > 0) {
                    ...
                    !i.isLoop) {
                        ...
                        const t = window.setInterval(()=>{
                            s.isRunning() || (window.clearInterval(t),
                            n())
                        }
                        , 500)
                    }
    ...
    new class {
        ...
        checkWx() {
            s.isWeiXin() ? (this.isMiniprogram = s.isMiniprogram(),
            this.isMiniprogram ? this.openCamera(!0) : (s.$show("#pageFirst"),
            s.isIos() && (s.$show("#pageWxIos"),
            s.$("#pageWxIos").addEventListener("click", ()=>{
                s.$hide("#pageWxIos")
            }
            , !1)),
            new n("wx.php","http://sightppp.oss-cn-shanghai.aliyuncs.com/webar/share.jpg","只需要浏览器，即可体验酷炫AR,快来试试吧~").shareSuccess = (e=>{
                window.setTimeout(()=>{
                    this.toPage("pageLottery"),
        ...
        startTurnTable() {
            this.isTurntableRunning || (s.$hide("#lotteryFail"),
            this.btnTurntableArrow.setAttribute("style", ""),
            t.get(this.apiHost + "lottery").then(e=>{
                const t = e.lottery.degree + 7200;
                this.userId = e.userId,
                window.setTimeout(()=>{
                    this.btnTurntableArrow.setAttribute("style", "transition: transform 5s;transform: rotate(" + t.toString() + "deg)"),
        ...
        pageLottery() {
            this.btnTurntableArrow = s.$("#btnTurntableArrow"),
            this.btnTurntableArrow.addEventListener("click", ()=>{
                this.startTurnTable()
            }
            , !1),
        ...
        pageContact() {
            ...
            s.$("#btnSubmitContact").addEventListener("click", ()=>{
                ...
                s.isMobile(i.mobile) ? i.contact.length < 2 ? alert("请输入正确的联系人！") : i.address.length < 5 ? alert("请输入正确的收件地址！") : e || (e = !0,
                t.post(this.apiHost + "user", i).then(e=>{
                    s.$show("#msgSubmitOK")
                }
                ).catch(t=>{
                    alert(t.message),
            ...
            , !1),
            s.$("#btnSubmitOK").addEventListener("click", ()=>{
                this.isMiniprogram ? this.toMiniPage() : s.reload()
            }
            , !1)
        }
        openCamera(e) {
            ...
            this.webAr.listCamera(t).then(i=>{
                ...
                this.webAr.openCamera(this.video, n).then(t=>{
                    e ? this.loadPackage() : (this.toPage("pageScan"),
                    ...
                    this.removeVideo(),
                    e ? this.loadPackage() : (alert("打开摄像头失败，请点击“立即体验”。"),
        ...
        updateProgress(e) {
            ...
            s.$("#loadingPercent").innerHTML = t < 100 ? t.toFixed(1) + "%" : "100%",
            t >= 100 && window.setTimeout(()=>{
        ...
        loadPackage(e=null) {
            e || (e = {
                model: "https://staticfile-cdn.sightp.com/easyar/webar/xiaoxiongmao.fbx",
                scale: .13,
                isLoop: !0,
                position: [0, -7, 0],
